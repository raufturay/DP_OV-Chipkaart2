...
FROM cursussen JOIN uitvoeringen ON 
cursussen.code = uitvoeringen.cursus
...
VALUES (8001, 'MULLER', 'TJ', 'STAGIAIR', 7566, '1982-08-18', 2000, null);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P','2024-03-02',7369,'Leerdam' )

ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P','2025-02-02',7369,'Leerdam' )

ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus,begindatum, evaluatie)
VALUES (7566, 'D&P','2024-03-02' , null);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus,begindatum, evaluatie)
VALUES (7369, 'D&P','2024-03-02' , null);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus,begindatum, evaluatie)
VALUES (7566, 'D&P','2024-03-02' , null);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
UPDATE medewerkers
SET salaris = salaris * 1.055
WHERE afd = 30
AND functie != 'MANAGER'

UPDATE medewerkers
SET salaris = salaris * 1.07
WHERE afdelingnaam = '30'
AND functie = 'MANAGER';
...
hij heeft een inschrijving staan voor een cursus
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm)
VALUES (8003, 'TURAY', 'R', 'KONING', NULL, '1982-08-18', 2000, null);
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm)
VALUES (8002, 'ZUTPHEN', 'D', 'HOOFD-FIN', 8003, '1982-08-18', 2000, null);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO afdelingen (anr, naam, locatie, hoofd) VALUES (70,'FINANCIEN', 'UTRECHT',8002)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
